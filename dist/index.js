...
loader.pitch = function (request) {
    ...
    var babelLoaderOptions = options && options.babelLoaderOptions ? options.babelLoaderOptions : null;
    var workerCompilationPlugins = options && options.plugins && options.plugins.length ? options.plugins : null;
    var importScripts = options && options.importScripts && options.importScripts.length ? options.importScripts : null;
    var cb = this.async();
    ...
    var entry = "!!" + (babelLoaderOptions ? 'babel-loader?' + JSON.stringify(babelLoaderOptions) + '!' : '') + (path.resolve(__dirname, 'rpc-worker-loader.js')) + "!" + request;
